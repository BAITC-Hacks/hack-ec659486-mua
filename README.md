...
**Для проверки нужен только Docker с Compose и Git. Ключ OpenAI, файл `.env` и установка Python/Node.js не требуются.** Запуск — три команды из раздела 7, затем кнопка «Тестовый комплект».
...
Подтверждённой публичной deployed-версии нет. Для проверки используйте локальный запуск
из раздела 7.
